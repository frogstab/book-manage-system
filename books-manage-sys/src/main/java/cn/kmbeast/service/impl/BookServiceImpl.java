 ...
 */
@Service
public class BookServiceImpl implements BookSaveService {
    ...
    public Result<Void> save(BookSave bookSave) {
        ...
        List<BookSaveVO> bookSaveVOS = bookSaveMapper.query(bookSaveQueryDto);
        if (!CollectionUtils.isEmpty(bookSaveVOS)) {
