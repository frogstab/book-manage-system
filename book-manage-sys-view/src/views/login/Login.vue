    ...
    methods: {
        ...
        async login() {
            ...
            try {
                ...
                // 保存 token
                setToken(mockData.data.token);
                
                // 保存用户信息到 sessionStorage
                sessionStorage.setItem('role', mockData.data.role);
                sessionStorage.setItem('userName', mockData.data.userName);
                sessionStorage.setItem('userAccount', mockData.data.userAccount);
