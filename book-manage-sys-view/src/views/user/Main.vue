...
export default {
    ...
    created() {
        this.readerProposalQueryDto.isPublish = true;
    ...
    methods: {
        ...
        postProposal() {
            this.proposal.isPublish = this.publishItemSelected === '公开' ? 1 : 0;
        ...
        paramCondition(tag) {
            if (tag === '全部') {
                ...
                this.queryUser = true;
                this.readerProposalQueryDto.isReply = null;
                this.readerProposalQueryDto.isPublish = null;
            }
            this.fetchReaderProposal();
        },
        // 读者建议查询
